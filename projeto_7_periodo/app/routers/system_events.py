"""Endpoints REST para ``system_event``."""
...
def list_all(
    ...
    only_unacknowledged: bool = Query(
        False, description="Inclui apenas eventos ainda não reconhecidos"
    ),
...
@router.get(
    "/{event_id}", response_model=SystemEvent, summary="Busca evento por id"
)
...
@router.post(
    ...
    response_model=SystemEvent,
    summary="Marca o evento como reconhecido por um operador",
)
